...
const SearchBar = ({ setSearchValue }) => (
  <div className="relative w-full mb-4">
    <input
      ...
      className="px-4 py-2 border border-gray-300 dark:border-gray-600 focus:ring-blue-500 focus:border-blue-500 block w-full rounded-md bg-primary text-gray-900 dark:text-gray-100"
    />
    <svg
