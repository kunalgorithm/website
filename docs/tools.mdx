...
- Front-end: [React](https://reactjs.org) and typescript, deployed to [`now`](https://zeit.co/now).
- Back-end Application Layer: [Node.js](https://nodejs.org) server deployed to [render](https://render.com).
- Data: [GraphQL](https://graphql.org), [Apollo](https://www.apollographql.com), and [Prisma](https://prisma.io).
- Styles: [Styled Components](https://www.styled-components.com/), [Reactstrap](https://reactstrap.github.io/), [Rebass](https://rebassjs.org/), and [Smooth UI](https://smooth-ui.smooth-code.com/).
