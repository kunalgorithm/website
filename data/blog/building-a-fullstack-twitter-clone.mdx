...
[![Finished Screenshot](/images/building-a-fullstack-twitter-clone/authed-screenshot.png)](https://fullstack-twitter.onrender.com)
...
![Feed JSON preview](/images/building-a-fullstack-twitter-clone/feed-json.png)
...
![Card Tweets with Ant Design preview](/images/building-a-fullstack-twitter-clone/card-tweets.png)
...
Now, render `<Profile />` in `pages/index.tsx` so we can view our new component.
...
I'm most responsive via email at [me@kunal.sh](mailto:me@kunal.sh) but feel free to DM me on [twitter](https://twitter.com/kunalshxh).
