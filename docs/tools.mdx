...
> Created 4/8/19; updated 4/14/19
...
- Front-end: [React](https://reactjs.org) and typescript, deployed to [ZEIT now](https://zeit.co/now).
...
- Server: [Node.js](https://nodejs.org) deployed to [render](https://render.com).
